<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">企业信息</span></div>
    </div>
    <div class="result-wrap">
        ...
        <div class="section">
			...
			<?php
			$action_url = '/enterprise/addAjax'; 
			if ($id) {
				$action_url = '/enterprise/updateAjax'; 
			}
			?>
            ...
            <div class="body">
                <ul class="base_info">
                    ...
                    <li>
                        <label >生产经营信息表:</label>
						<input type="file"  class="input1 floatL" name="cs_res" value="">
						<?php if ($id && $user_info_list['sc_res']) { ?>
						<a href='<?php echo MAIN_PATH.$user_info_list['sc_res']; ?>' target="_blank">查看</a>
						<?php } ?>
                    </li>
                    <li>
                        <label >营业执照：</label>
						<input type="file"  class="input1 floatL" name="yy_res" value="">
						<?php if ($id && $user_info_list['yy_res']) { ?>
						<a href='<?php echo MAIN_PATH.$user_info_list['yy_res']; ?>' target="_blank">查看</a>
						<?php } ?>
                    </li>
                    <li>
                        <label >组织机构代码证：</label>
						<input type="file"  class="input1 floatL" name="og_res" value="">
						<?php if ($id && $user_info_list['og_res']) { ?>
						<a href='<?php echo MAIN_PATH.$user_info_list['og_res']; ?>' target="_blank">查看</a>
						<?php } ?>
                    </li>
                    <li>
                        <label >税务证：</label>
						<input type="file"  class="input1 floatL" name="xw_res" value="">
						<?php if ($id && $user_info_list['xw_res']) { ?>
						<a href='<?php echo MAIN_PATH.$user_info_list['xw_res']; ?>' target="_blank">查看</a>
						<?php } ?>
                    ...
                    <li>
                        <label >其它附件：</label>
						<input type="file"  class="input1 floatL" name="other_res" value="">
						<?php if ($id && $user_info_list['other_res']) { ?>
						<a href='<?php echo MAIN_PATH.$user_info_list['other_res']; ?>' target="_blank">查看</a>
						<?php } ?>
                    </li>
            ...
            <div class="body">
                ...
                <ul class="base_info show_no1">
                    ...
                    <li>
                        ...
                        <div class="text_1"><input name="m_bx_one" type="text" value="<?php echo $user_info_list['one_info']['m_bs']; ?>" /> </div>
                    </li>
                </ul>
                <ul class="base_info show_no2">
                    ...
                    <li>
                        <label >报税工资表年平均人数：</label>
                        <div class="text_1"><input name="m_bx_two" type="text" value="<?php echo $user_info_list['two_info']['m_bs']; ?>" /> </div>
                    </li>
                </ul>
                <ul class="base_info show_no3">
                    ...
                    <li>
                        <label >报税工资表年平均人数：</label>
                        <div class="text_1"><input name="m_bx_three" type="text" value="<?php echo $user_info_list['three_info']['m_bs']; ?>" /> </div>
                    </li>
                </ul>
            </div>
        </div>
