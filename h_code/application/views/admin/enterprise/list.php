            ...
            <form method="get">
                <table class="search-tab">
                    <tr>
                        ...
                        <td><a class="btn btn-primary btn2" href="/enterprise/addUpdateInfo"  target='_blank'>增加企业信息</a></td>
                    </tr>
                </table>
            </form>
        </div>
                ...
                <table class="result-tab" width="100%">
                    ...
                    <?php foreach($data as $v){?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo ADMIN_PATH.'/enterprise/addUpdateInfo?id='.$v['id'];?>">修改</a>
                            </td>
                        </tr>
                    <?php }?>
                </table>
