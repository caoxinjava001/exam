<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">业务员列表</span></div>
    </div>
    ...
    <div class="result-wrap">
        <form name="myform" id="myform" method="post">
            ...
            <a id="updateOrd" href="/manage_sale/index" style="float: right;margin-top: 158px;position: absolute;right: 20px;top: 0;" class="btn btn-primary btn2"><i class="icon-font"></i>创建业务员</a>
            <!--                </div>-->
            <!--            </div>-->
