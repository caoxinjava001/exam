        ...
        <form id="sale_from">
            ...
            <div class="demand_text">
                <div class="text">
                    ...
                    <input type="text" class="sect_1 floatL" name="admin_user[name]" placeholder="请填写用真实姓名" value="<?php echo $member_info[name]?$member_info[name]:''?>">
                ...
                <div class="text">
                    ...
                    <input type="text" class="sect_1 floatL" name="admin_user[service_code]" placeholder="请输入4位业务代码" value="<?php echo $member_info[service_code]?$member_info[service_code]:''?>">
                    <span class="span2 floatL">请填写业务代码</span>
                </div>
                <div class="text">
...
<!--<script>
    ...
    /*$('#createManager').bind('click',function(){
        if(b) {
            var obj = {}, _msg={};
            var up_data = $('#sale_from').serialize();
            obj.data = up_data;
            obj.type = 'post';
            obj.url = config.domain.wf+'/manage_sale/createManager';
...
<script type="text/javascript" src="<?php echo STATICS_PATH;?>/js/sale_add.js"></script>
