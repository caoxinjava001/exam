                ...
                <div class="certification_img ">
                 ...
                 <!--   <div class="certification_im1 floatL">
                    ...
                    <div class="certification_im2 floatL none">
                        <img src="http://182.92.72.93:9010/statics/main/backend/images/icon_qita.jpg" alt="" />
                    </div>
                    ...
                    <div class="box_l1 text clearB clearfix">
                        ...
                        <select class="sect_2 floatL" name="id_type" id="papers_type">
                            <option <?php echo $member_info['identify_type'] == 0 ?'selected="selected"':'';?> value="0">--请选择--</option>
                            <option <?php echo $member_info['identify_type'] == 1 ?'selected="selected"':'';?> value="1">身份证</option>
                            <option <?php echo $member_info['identify_type'] == 2 ?'selected="selected"':'';?> value="2">护照</option>
                        </select>
                    </div>

                    <div class="box_l2 text">
                        <span class="text_span">请输入证件号码:</span>
                        <input type="text" class="input1" value="<?php echo $member_info['identify_num']?$member_info['identify_num']:'';?>" name="id_number" id="papers_num" placeholder="证件号码">
                    </div>
                </div>
                <div class="Upload clearB clearfix">
                    <div id="apply_for_upload" class="btn2"></div>
                    <div class="other_upload upload_info" style="<?php echo $member_info['identify_pic']?'display: block;':'display: none;'; ?>">
                      <!--  <div class="certification_im1 floatL">
                            <img src="http://182.92.72.93:9010/statics/main/backend/images/icon_qi2.jpg" alt="" />
                        </div>-->
                        <div class="certification_im2 floatL">
                            <div class="upload_img_center">
                                <img real_url="<?php echo $member_info['identify_pic'] ?>" src="<?php echo $member_info['identify_pic']?PIC_PATH.'/magic/w_273/h_191'.$member_info['identify_pic']:'http://182.92.72.93:9010/statics/main/backend/images/icon_qita.jpg';?>" alt="" />
                            </div>
                        </div>
                        <input type="hidden" name="id_pic" value="<?php echo $member_info['identify_pic']?$member_info['identify_pic']:'';?>">
        ...
        ;(function(){
            var approve_from="#approve_from", _mark_upload= 0,menber_id=$("#member_id",approve_from).val(),
                ...
                $("#approve_id",approve_from).on("click",function(){
                    ...
                    p.url="http://182.92.72.93:9010/register_cop/ajax_auth_save?flag=1&"+$(approve_from).serialize();
                    _util.ajax(p,function(d){
                        if(d&& d.status&& d.status==1){
                            ...
                            error_msg.callback=function(){
                                    ...
                                    if(login_role_id==2){
                                        _util.showAutoBg(true);
                                        window.location.href=config.domain.wf+"/register_cop/auth_sec?member_id="+menber_id;
                                    }
                            }
                            _show_msg(error_msg);
                        }else{
