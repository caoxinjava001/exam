<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">试卷分类列表</span></div>
    </div>
            ...
            <form method="get">
                <table class="search-tab">
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <a id="updateOrd" href="/classify/create" class="btn btn-primary btn2"><i class="icon-font"></i>增加分类</a>
                        </td>
                    </tr>
