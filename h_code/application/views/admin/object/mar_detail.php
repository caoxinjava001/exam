        ...
        <div class="section">
            ...
            <div class="body">
                <ul class="base_info">
                    ...
                    <li>
                        <label >股票代码：</label>
                        <div class="text_1"><?php echo $stock_code;?></div>
                    </li>
                    <li>
                        <label >现股价：</label>
                        <div class="text_1"><?php echo $stock_value;?></div> 元
                    </li>
                    <li>
                        <label >市盈率：</label>
                        <div class="text_1"><?php echo $profit;?></div> %
                    </li>
                    <li>
                        <label >市净率：</label>
                        <div class="text_1"><?php echo $net_profit;?></div> %
                    </li>
                    <li>
                        <label >商定投资价格：</label>
                        <div class="text_1"><?php echo $invest_value;?></div> 元
                    </li>
                    <li>
                        <label >投资年财务预期：</label>
                        <div class="text_1"><?php echo $fin_exp;?></div> 万元
                    </li>
        ...
        <div class="section">
            ...
            <div class="body">
                ...
                <ul class="base_info show_no<?php echo $i;?>">
                    <li>
                        <label >资产总额:</label>
                        <div class="text_1"><?php echo $v['zc_total']?$v['zc_total']:0;?> 万元</div>
                    </li>
                    <li>
                        <label >净资产：</label>
                        <div class="text_1"><?php echo $v['jzc_total']?$v['jzc_total']:0;?> 万元</div>
                    </li>
                    <li>
                        <label >营业成本额：</label>
                        <div class="text_1"><?php echo $v['yy_cb']?$v['yy_cb']:0;?> 万元</div>
                    </li>
                    <li>
                        <label >企业所得税：</label>
                        <div class="text_1"><?php echo $v['qy_sd']?$v['qy_sd']:0;?> 万元</div>
                    </li>
                    <li>
                        <label >净利润：</label>
                        <div class="text_1"><?php echo $v['m_ly']?$v['m_ly']:0;?> 万元</div>
                    </li>
                </ul>
                <?php $i++;}?>
            </div>
