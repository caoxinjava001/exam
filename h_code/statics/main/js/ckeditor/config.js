...
CKEDITOR.editorConfig = function( config )
{
	...
	config.extraPlugins = 'capture,equation,videoforpc';
	...
	config.toolbar_MyToolbar =  
	    [  
	     	['Bold', 'Italic', '-', 'NumberedList', 'BulletedList', '-', 'Link', 'Unlink', 'Equation','Image']  
	    ];  
	config.toolbarCanCollapse = false;// 工具栏是否可以被收缩  
    config.resize_enabled = false;// 取消 “拖拽以改变尺寸”功能 plugins/resize/plugin.js 
   
    config.filebrowserImageUploadUrl  = 'http://statics.yduedu.com/orgmange/js/ckeditor/ckupload.php';
